...
if pagina_seleccionada == 'Inicio':
    ...
    texto = """
    Hola, Bienvenidos a mi Blog, Mi nombre es Ivan Gonzales
    tengo 19 años y estudio la carrera de publicidad en la PUCP, elegi
    esta carrera pues me permite combinar la creatividad con el pensamiento 
    estratégico para impactar a la sociedad.Mis hobbies son salir a caminar,
    dibujar y pintar. En este blog mostrare mi progreso de la clase
    de pensamiento computacional para las comunicaciones durante el ciclo 2025-2
    """
